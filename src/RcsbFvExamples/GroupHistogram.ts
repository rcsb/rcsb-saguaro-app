...
buildGroupMembers("selectBis", GroupProvenanceId.ProvenanceSequenceIdentity, "1507_30", 1, 1)
...
buildGroup("pfv_3", GroupProvenanceId.ProvenanceSequenceIdentity, "5_30", undefined, ["EXPERIMENTAL_METHOD_FACET","PFAM_FACET","GO_FUNCTION_FACET","GO_PROCESS_FACET","GO_COMPONENT_FACET"]).then((m)=>{
});
