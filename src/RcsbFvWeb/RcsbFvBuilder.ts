...
export function getFeatures(elementFvId: string): Promise<Array<Feature>>{
    return rcsbFvCtxManager.getFeatures(elementFvId);
}
...
export function buildUniprotFv(elementId: string, upAcc: string, additionalConfig?:RcsbFvModuleAdditionalConfig): Promise<RcsbFvModulePublicInterface> {
    return RcsbFvUniprotBuilder.buildUniprotFv(elementId, upAcc, additionalConfig);
}

export function buildEntityFv(elementId: string, entityId: string, additionalConfig?:RcsbFvModuleAdditionalConfig): Promise<RcsbFvModulePublicInterface> {
    return RcsbFvEntityBuilder.buildEntityFv(elementId, entityId, additionalConfig);
}

export function buildInstanceFv(elementId: string, instanceId: string, additionalConfig?:RcsbFvModuleAdditionalConfig): Promise<RcsbFvModulePublicInterface> {
    return RcsbFvInstanceBuilder.buildInstanceFv(elementId, instanceId, additionalConfig);

}

export function buildUniprotEntityFv(elementId: string, upAcc: string, entityId: string, additionalConfig?:RcsbFvModuleAdditionalConfig): Promise<RcsbFvModulePublicInterface> {
    return RcsbFvUniprotBuilder.buildUniprotEntityFv(elementId, upAcc, entityId, additionalConfig);
}

export function buildUniprotEntityInstanceFv(elementId: string, upAcc: string, entityId: string, instanceId: string, additionalConfig?:RcsbFvModuleAdditionalConfig): Promise<RcsbFvModulePublicInterface> {
...
export function buildInstanceTcgaFv(elementFvId:string, elementSelectId:string, entryId: string, config?: InstanceSequenceConfig): Promise<RcsbFvModulePublicInterface> {
