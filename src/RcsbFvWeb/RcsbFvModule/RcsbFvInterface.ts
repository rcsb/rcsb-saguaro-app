...
export class RcsbFvInterface extends RcsbFvAbstractModule {
    ...
    private async typeSuffix(ann: SequenceAnnotations, d: Feature): Promise<string|undefined> {
    ...
    private titleSuffix(rcsbContext?: RcsbContextType): ((ann: SequenceAnnotations, d: Feature)=>Promise<string|undefined>) {
        return (async (ann: SequenceAnnotations, d: Feature) => {
    ...
    private async trackTitle(ann: SequenceAnnotations, d: Feature): Promise<string|undefined> {
