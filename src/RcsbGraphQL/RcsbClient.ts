...
class RcsbClientClass {
    ...
    private readonly rcsbQueryAlignment: RcsbCoreQueryInterface<QueryAlignmentArgs,SequenceAlignments>;
    ...
    public async requestAlignment(requestConfig: QueryAlignmentArgs): Promise<SequenceAlignments>{
