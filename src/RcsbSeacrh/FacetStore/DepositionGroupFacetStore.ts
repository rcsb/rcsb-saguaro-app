...
class DepositionGroupFacetStore implements FacetStoreInterface{
    ...
    private readonly instanceFacet: FacetMemberInterface[] = [SCOP_FACET,CATH_FACET,ECOD_FACET,LIGAND_FACET,LIGAND_OF_INTEREST_FACET];
...
export const depositionGroupFacetStore: DepositionGroupFacetStore = new DepositionGroupFacetStore();