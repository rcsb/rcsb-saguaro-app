...
import {
    ...
    METHODOLOGY_FACET, CHIMERIC_FACET, DISEASE_FACET, INTERPRO_FACET, PHENOTYPE_FACET
} from "./SingleFacets";
...
export const sequenceGroupFacetStore: SequenceGroupFacetStore = new SequenceGroupFacetStore();